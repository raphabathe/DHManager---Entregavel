...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Aqui uma boa pratica seria colocar o objeto professo e buscar o codigo
        // assim a leitura do codigo fica mais clara sem tantos IDs soltos
//        manager.alocarProfessores(20001,professorTitular2.getCodigoProfessor(),professorAdjunto2.getCodigoProfessor());
        ...
        // Acho que o mesmo vale pra ca, mas so seria possivel se o metodo registrar aluno retornasse um aluno
//        Aluno aluno1 = manager.registrarAluno("Raphael", "Bathe", 001);
//        manager.matricularAluno(aluno1.getCodigo(),20001);
